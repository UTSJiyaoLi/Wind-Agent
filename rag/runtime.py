...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=os.getenv(
            ...
            os.getenv("ORCH_LLM_BASE_URL", os.getenv("VLLM_BASE_URL", "http://127.0.0.1:9001")),
        ),
    )
    parser.add_argument(
        "--planner-model",
        default=os.getenv("PLANNER_LLM_MODEL", os.getenv("ORCH_LLM_MODEL", os.getenv("VLLM_MODEL", ""))),
    )
    parser.add_argument(
        "--planner-api-key",
        default=os.getenv("PLANNER_LLM_API_KEY", os.getenv("ORCH_LLM_API_KEY", os.getenv("VLLM_API_KEY", "EMPTY"))),
    )
    parser.add_argument(
        "--planner-timeout-seconds",
        type=int,
        default=int(os.getenv("PLANNER_LLM_TIMEOUT", os.getenv("ORCH_LLM_TIMEOUT", "60"))),
    )
